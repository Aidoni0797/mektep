...
urlpatterns = [
    ...
    path('addnewtest/<int:pk>/',views.addnewtest,name='addnewtest'),
    path('createtest/<int:pk>/',views.createnewtest,name='createtest'),
    path('testdetail/<int:pk>/',views.test_detail,name='testdetail'),
    path('createquestion',views.createnewquestion,name='createquestion'),
